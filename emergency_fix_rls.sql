-- EMERGENCY FIX: Completely disable RLS and fix progress tracking
...
GRANT ALL ON user_progress TO authenticated, anon, service_role;
...
-- Step 5: Update NULL values to defaults
...
FROM pg_tables 
WHERE tablename IN ('users', 'language_levels', 'user_progress', 'words_quiz');
